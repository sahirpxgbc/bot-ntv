...
client.on('message', message => {
  ...
  const mensajesAutomaticos = [
    ...
    },
    {
      titulo: '`💡` Consejo... `💡`',
      color: '#E4FA00',
      descripcion: 'Recuerda que antes de publicar un articulo en Neshy Roleplay, debes publicarlo en;' 
      + '<#1104201811629445251>. Evita publicarlo directamente sin haber sido aprobado, puedes recibir una '
      +'advertencia.',
    },
    {
      titulo: '`💡` Consejo... `💡`',
